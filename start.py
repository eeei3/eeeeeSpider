...
"""
/***************************************************************************************
This is the main part of this application. This is the code to run
to start the program. Here you will find the CLI prompts, configuration
choices and start up and end functions.
***************************************************************************************\
"""
import os
import sys
...
class Main:
    ...
    ***************************************************************************************\
    ...
    def __init__(self, directory, cdirectory="configs"):
        ...
        self.configs = {
            ...
            "outside_sites": False,
            # If the crawler has a limit imposed on the max
            # amount of sites it can crawl
            "max_links": [False, 0],
    ...
    ***************************************************************************************\
    ...
    """
    /***************************************************************************************
    Function that creates a gui using Tkinter.
    Then it creates a scrollbar object and the text element
    that is created gets populated with the links.
    ***************************************************************************************\
    """
    @staticmethod
        ...
        ***************************************************************************************\
        ...
        def export_to_csv():
            ...
            with open(self.directory + '/crawled.csv', 'x',
                ...
                with open(self.directory + "/crawled.txt", "r",
...
***************************************************************************\
        ...
        # The user wishes to export the results in a format of their choice
            ...
            crawledfile = self.directory + "/crawled.txt"

            with open(crawledfile, "r", encoding='utf8') as file:
                url_list = file.read()
                url_list = url_list.split("\n")
...
\___|\___|\___|\___|\___||___/|_|   |_|\__/_|\___||_|
""")
    ...
    ***************************************************************************************\
    ...
    def settings(self):
        ...
        print("7.Regenerate config file\n8.Nothing/Save changes and exit")
        ...
        # User wishes to change HTML settings
            ...
            # entered in as links or as plain text
                ...
                if temp1.lower() == "e":
                    ...
                    # The user chose to make no changes
